...
export const Header: React.FC<HeaderProps> = React.memo(
  ({
    ...
    return (
      <header className="sticky top-0 z-50 mb-2 border-b border-white/10 bg-black/60 p-2 shadow-lg shadow-black/40 sm:top-4 sm:mb-6 sm:rounded-xl sm:bg-black/55 sm:p-4 animate-in fade-in duration-300">
  <div className="flex flex-col items-center justify-between gap-2 sm:flex-row sm:gap-3 w-full">
    ...
    {!streamUrl && (
      <div className="flex w-full flex-col items-center gap-2 sm:w-auto sm:flex-row sm:flex-wrap sm:justify-end sm:gap-2">
        ...
        <div className="flex w-full justify-between space-x-1 rounded-full border border-white/10 bg-[#0b1120]/85 p-1 transition-all duration-300 sm:w-auto sm:space-x-2">
          {onSelectDiscover && (
            <button
              ...
              data-focusable="true"
              data-default-focus={isDiscoverActive ? 'true' : undefined}
              tabIndex={-1}
              title="Discover"
            >
              <span className="mr-1 sm:hidden">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 3l1.9 5.8L20 11l-6.1 2.2L12 19l-1.9-5.8L4 11l6.1-2.2L12 3z" />
                </svg>
              </span>
              <span>Discover</span>
            </button>
          ...
          <button
            ...
            data-focusable="true"
            data-default-focus={!isDiscoverActive && contentType === 'movie' ? 'true' : undefined}
            tabIndex={-1}
            title="Movies"
          >
            <span className="mr-1 sm:hidden">
          ...
          <button
            ...
            data-focusable="true"
            data-default-focus={!isDiscoverActive && contentType === 'series' ? 'true' : undefined}
            tabIndex={-1}
            title="Series"
          >
            <span className="mr-1 sm:hidden">
          ...
          <button
            ...
            data-focusable="true"
            data-default-focus={!isDiscoverActive && contentType === 'tv' ? 'true' : undefined}
            tabIndex={-1}
            title="TV"
          >
            <span className="mr-1 sm:hidden">
